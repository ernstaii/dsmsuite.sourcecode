...
set PROJECTS=DsmSuite.Analyzer.Compare DsmSuite.Analyzer.Cpp DsmSuite.Analyzer.DotNet DsmSuite.Analyzer.JDeps DsmSuite.Analyzer.Python DsmSuite.Analyzer.UML DsmSuite.DsmViewer.View
